...
namespace SIMSA.Pages
{
	...
	public partial class Morse : ContentPage, IConfigurable
	{
		...
		public Morse(Config config, MorseCode morseCode)
		{
			...
			add0.Clicked += (o, a) => SetCode(morse.Add('0', input.CursorPosition), input.CursorPosition + 1);
			add1.Clicked += (o, a) => SetCode(morse.Add('1', input.CursorPosition), input.CursorPosition + 1);
